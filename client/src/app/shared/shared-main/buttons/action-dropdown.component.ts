...
export type DropdownAction<T, D = never> = {
  ...
  // Refatorado: 'any' -> 'void' ou 'unknown' (handlers de clique geralmente não retornam valor usado)
...
export class ActionDropdownComponent<T, D = never> implements OnChanges {
  ...
  dropdownItemExtra: TemplateRef<unknown>;

  // Refatorado: TemplateRef<any> -> TemplateRef<unknown>
  @ContentChild('labelExtra', { descendants: false })
  labelExtra: TemplateRef<unknown>;
