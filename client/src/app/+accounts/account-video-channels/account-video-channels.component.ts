...
export class AccountVideoChannelsComponent implements OnInit, OnDestroy {
  ...
  ngOnInit() {
    ...
    this.accountSub = this.accountService.accountLoaded.subscribe((account) => {
  ...
  loadMoreChannels() {
    ...
    this.videoChannelService
      ...
      .subscribe(async ({ videoChannel, videos, total }) => {
        this.channelsDescriptionHTML[videoChannel.id] =
          await this.markdown.textMarkdownToHTML({
