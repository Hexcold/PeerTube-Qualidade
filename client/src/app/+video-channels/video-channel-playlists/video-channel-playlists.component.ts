...
export class VideoChannelPlaylistsComponent
  implements OnInit, AfterViewInit, OnDestroy
{
  ...
  ngOnInit() {
    ...
    this.videoChannelSub =
      this.videoChannelService.videoChannelLoaded.subscribe((videoChannel) => {
